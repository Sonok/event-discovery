          ...
          {Array.from({ length: 40 }, (_, i) => (
            <div
              ...
              className={`absolute w-px h-px rounded-full animate-pulse ${
                i % 4 === 0 ? 'bg-space-silver/40' :
                i % 4 === 1 ? 'bg-space-cyan/40' :
                i % 4 === 2 ? 'bg-space-gold/40' :
                'bg-white/40'
              }`}
              style={{
                top: `${5 + (i * 7) % 90}%`,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-white/80 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="hidden dark:block">
                When the sun sets, the real connections begin. Find your tribe in the city's
                electric nightlife scene. Our AI connects night owls, explorers, and urban
                adventurers ready to light up the darkness together.
              </span>
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-3xl p-8 text-center hover:bg-white/15 dark:hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-white/70 dark:text-white/80">
                ...
                <span className="hidden dark:block">
                  Advanced neural networks analyze your nightlife preferences, energy levels,
                  and adventure style to connect you with the perfect night crew.
                </span>
              </p>
            </div>
            ...
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-3xl p-8 text-center hover:bg-white/15 dark:hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-white/70 dark:text-white/80">
                ...
                <span className="hidden dark:block">
                  Discover hidden speakeasies, rooftop parties, late-night food spots,
                  and underground events that make your city come alive after dark.
                </span>
              </p>
            </div>
            ...
            <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-3xl p-8 text-center hover:bg-white/15 dark:hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
              ...
              <p className="text-white/70 dark:text-white/80">
                ...
                <span className="hidden dark:block">
                  Form deep bonds with fellow night explorers who share your passion
                  for adventure, creativity, and making the most of city nights.
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-white/80 text-lg mb-2">
              ...
              <span className="hidden dark:block">
                "WTM? connected me with the most amazing night crew. Every weekend is an adventure!"
              </span>
            </p>
